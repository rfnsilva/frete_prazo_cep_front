...
@Component({
  selector: 'app-calc-preco-prazo',
  templateUrl: './calc-preco-prazo.component.html',
  styleUrls: ['./calc-preco-prazo.component.scss']
})
  
export class CalcPrecoPrazoComponent implements OnInit {
  ...
  calc(produto: any) {
    ...
    this.http.post(`${this.apiURL}/calc_preco_prazo`, produto, { 'headers': headers })
      .subscribe(result => {
        this.result = result;
        this.ctrl = false;
    });
